...
class TestGraphs:
    ...
    def test_add_entry(self, batch):
        graph = deglib.DynamicExplorationGraph.create_empty(self.data.shape[0], deglib.FloatSpace.create(self.data.shape[1], deglib.Metric.FP32_L2), self.edges_per_vertex)
