...
void run_static_benchmark(const DatasetName& ds_name, const std::filesystem::path& data_path, bool force_rebuild, deglib::distances::InstructionSet instruction, uint32_t build_threads) {
