...
TEST(DeglibBuilderRegression, EVPInnerProduct_Benchmark_AVX512) {
    ...
    run_regression_test(
        "EVPInnerProduct_AVX512", deglib::distances::Metric::EVP_InnerProduct, 35000.0, 6.0, 0.898, base_data.data(), query_data.data(), base_count,
...
TEST(DeglibBuilderRegression, EVPInnerProduct_Benchmark_AVX2) {
    ...
    run_regression_test(
        "EVPInnerProduct_AVX2", deglib::distances::Metric::EVP_InnerProduct, 41000.0, 4.7, 0.85301, base_data.data(), query_data.data(), base_count,
...
TEST(DeglibBuilderRegression, EVPInnerProduct_Benchmark_Scalar) {
    ...
    run_regression_test(
        "EVPInnerProduct_Scalar", deglib::distances::Metric::EVP_InnerProduct, 47000.0, 4.0, 0.741, base_data.data(), query_data.data(), base_count,
...
TEST(DeglibBuilderRegression, L2Float_Benchmark_AVX512) {
    ...
    run_regression_test(
        "L2Float_AVX512", deglib::distances::Metric::FP32_L2, 53000.0, 6.0, 0.961, base_data.data(), query_data.data(), base_count, query_count, dim, gt_data,
...
TEST(DeglibBuilderRegression, L2Float_Benchmark_AVX2) {
    ...
    run_regression_test(
        "L2Float_AVX2", deglib::distances::Metric::FP32_L2, 53000.0, 6.0, 0.961, base_data.data(), query_data.data(), base_count, query_count, dim, gt_data,
...
TEST(DeglibBuilderRegression, L2Float_Benchmark_Scalar) {
    ...
    run_regression_test(
        "L2Float_Scalar", deglib::distances::Metric::FP32_L2, 22000.0, 14.0, 0.971, base_data.data(), query_data.data(), base_count, query_count, dim, gt_data,
...
TEST(DeglibBuilderRegression, InnerProductFloat_Benchmark_AVX512) {
    ...
    run_regression_test(
        "InnerProductFloat_AVX512", deglib::distances::Metric::FP32_InnerProduct, 42000.0, 4.5, 0.866, base_data.data(), query_data.data(), base_count,
...
TEST(DeglibBuilderRegression, InnerProductFloat_Benchmark_AVX2) {
    ...
    run_regression_test(
        "InnerProductFloat_AVX2", deglib::distances::Metric::FP32_InnerProduct, 42000.0, 4.5, 0.866, base_data.data(), query_data.data(), base_count,
...
TEST(DeglibBuilderRegression, InnerProductFloat_Benchmark_Scalar) {
    ...
    run_regression_test(
        "InnerProductFloat_Scalar", deglib::distances::Metric::FP32_InnerProduct, 20000.0, 9.8, 0.867, base_data.data(), query_data.data(), base_count,
...
TEST(DeglibBuilderRegression, L2Uint8_Benchmark_AVX512) {
    ...
    run_regression_test(
        "L2Uint8_AVX512", deglib::distances::Metric::Uint8_L2, 66000.0, 4.8, 0.99, base_data.data(), query_data.data(), base_count, query_count, dim, gt_data,
...
TEST(DeglibBuilderRegression, L2Uint8_Benchmark_AVX2) {
    ...
    run_regression_test(
        "L2Uint8_AVX2", deglib::distances::Metric::Uint8_L2, 66000.0, 4.9, 0.99, base_data.data(), query_data.data(), base_count, query_count, dim, gt_data,
...
TEST(DeglibBuilderRegression, L2Uint8_Benchmark_Scalar) {
    ...
    run_regression_test(
        "L2Uint8_Scalar", deglib::distances::Metric::Uint8_L2, 55000.0, 5.8, 0.99, base_data.data(), query_data.data(), base_count, query_count, dim, gt_data,
...
TEST(DeglibBuilderRegression, InnerProductFP16_Benchmark_AVX512) {
    ...
    run_regression_test(
        "InnerProductFP16_AVX512", deglib::distances::Metric::FP16_InnerProduct, 52000.0, 4.2, 0.866, base_data.data(), query_data.data(), base_count,
...
TEST(DeglibBuilderRegression, InnerProductFP16_Benchmark_AVX2) {
    ...
    run_regression_test(
        "InnerProductFP16_AVX2", deglib::distances::Metric::FP16_InnerProduct, 52000.0, 4.2, 0.866, base_data.data(), query_data.data(), base_count,
...
TEST(DeglibBuilderRegression, InnerProductFP16_Benchmark_Scalar) {
    ...
    run_regression_test(
        "InnerProductFP16_Scalar", deglib::distances::Metric::FP16_InnerProduct, 8000.0, 25.0, 0.867, base_data.data(), query_data.data(), base_count,
