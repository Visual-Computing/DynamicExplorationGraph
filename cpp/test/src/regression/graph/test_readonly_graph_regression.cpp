...
TEST(ReadOnlyGraphRegression, SearchAndExplore_FP32_L2) {
    ...
    std::cout << "[BENCHMARK 100x] ReadOnlyGraph FP32_L2 search(): " << total_search_ms << " ms total for " << total_queries << " queries ("
    ...
    std::cout << "[BENCHMARK 100x] ReadOnlyGraph FP32_L2 explore(): " << total_explore_ms << " ms total for " << total_explorations << " explorations ("
...
TEST(ReadOnlyGraphRegression, SearchAndExplore_FP32_InnerProduct) {
    ...
    std::cout << "[BENCHMARK 100x] ReadOnlyGraph FP32_InnerProduct search(): " << total_search_ms << " ms total for " << total_queries << " queries ("
              << (total_search_ms / total_queries) << " ms/q), " << search_qps << " QPS, recall=" << (search_recall * 100.0f) << "%\n";
    ...
    std::cout << "[BENCHMARK 100x] ReadOnlyGraph FP32_InnerProduct explore(): " << total_explore_ms << " ms total for " << total_explorations
...
TEST(ReadOnlyGraphRegression, SearchAndExplore_EVP_InnerProduct) {
    ...
    std::cout << "[BENCHMARK 100x] ReadOnlyGraph EVP_InnerProduct search(): " << total_search_ms << " ms total for " << total_queries << " queries ("
              << (total_search_ms / total_queries) << " ms/q), " << search_qps << " QPS, recall=" << (search_recall * 100.0f) << "%\n";
    ...
    std::cout << "[BENCHMARK 100x] ReadOnlyGraph EVP_InnerProduct explore(): " << total_explore_ms << " ms total for " << total_explorations
              << " explorations (" << (total_explore_ms / total_explorations) << " ms/q), " << explore_qps << " QPS, recall=" << (explore_recall * 100.0f)
              << "%\n";
}
...
TEST(ReadOnlyGraphRegression, MultiThreadedSearch_HighDim_Scaling) {
    ...
    run_multithreaded_search_benchmark(
        "ReadOnlyGraph FP32_L2 (1024D)", graph, query_data, query_count, dim, search_k, search_eps, gt_data, {1, 2, 4, 8}, benchmark_runs
    );
}
...
TEST(ReadOnlyGraphRegression, MultiThreadedSearch_LowDim_Scaling) {
    ...
    run_multithreaded_search_benchmark(
        "ReadOnlyGraph FP32_L2 (64D)", graph, query_data, query_count, dim, search_k, search_eps, gt_data, {1, 2, 4, 8}, benchmark_runs
    );
}
