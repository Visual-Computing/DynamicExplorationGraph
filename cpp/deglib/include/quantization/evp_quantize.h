...
// ============================================================================
// Similarity (operates on raw bytes, no container needed)
// ============================================================================
 ...
 *
 * Layout per vector: [ones (dim/8)][negative_ones (dim/8)]
 *
 * Formula: (aa + bb + dim*2) - (cc + dd)
 */
inline float similarity_bytes(const std::byte* ones_a, const std::byte* negs_a,
 ...
 */
inline float max_similarity(uint32_t dim, uint32_t non_zeros) {
