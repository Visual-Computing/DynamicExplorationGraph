...
class ReadOnlyGraph : public deglib::search::SearchGraph {
  ...
  template <bool use_max_distance_count = false, bool use_filter = false>
  inline static deglib::search::ResultSet searchFP16InnerProductExt8(const ReadOnlyGraph& graph, const std::vector<uint32_t>& entry_vertex_indices, const std::byte* query, const float eps, const uint32_t k, const deglib::graph::Filter* filter = nullptr, const uint32_t max_distance_computation_count = 0) {
  ...
  template <bool use_max_distance_count = false, bool use_filter = false>
  inline static deglib::search::ResultSet searchFP16InnerProductExt16(const ReadOnlyGraph& graph, const std::vector<uint32_t>& entry_vertex_indices, const std::byte* query, const float eps, const uint32_t k, const deglib::graph::Filter* filter = nullptr, const uint32_t max_distance_computation_count = 0) {
  ...
  template <bool use_max_distance_count = false, bool use_filter = false>
  inline static deglib::search::ResultSet searchFP16InnerProductExt32(const ReadOnlyGraph& graph, const std::vector<uint32_t>& entry_vertex_indices, const std::byte* query, const float eps, const uint32_t k, const deglib::graph::Filter* filter = nullptr, const uint32_t max_distance_computation_count = 0) {
  ...
  template <bool use_max_distance_count = false, bool use_filter = false>
  inline static deglib::search::ResultSet searchFP16InnerProductExt16Residual(const ReadOnlyGraph& graph, const std::vector<uint32_t>& entry_vertex_indices, const std::byte* query, const float eps, const uint32_t k, const deglib::graph::Filter* filter = nullptr, const uint32_t max_distance_computation_count = 0) {
  ...
  template <bool use_max_distance_count = false, bool use_filter = false>
  inline static deglib::search::ResultSet searchFP16InnerProductExt8Residual(const ReadOnlyGraph& graph, const std::vector<uint32_t>& entry_vertex_indices, const std::byte* query, const float eps, const uint32_t k, const deglib::graph::Filter* filter = nullptr, const uint32_t max_distance_computation_count = 0) {
  ...
  inline static SEARCHFUNC getSearchFunction(const deglib::FloatSpace& feature_space) {
    ...
    {
      if (dim % 32 == 0)
        return deglib::graph::ReadOnlyGraph::searchFP16InnerProductExt32<use_max_distance_count, use_filter>;
      else if (dim % 16 == 0)
        return deglib::graph::ReadOnlyGraph::searchFP16InnerProductExt16<use_max_distance_count, use_filter>;
      else if (dim % 8 == 0)
        return deglib::graph::ReadOnlyGraph::searchFP16InnerProductExt8<use_max_distance_count, use_filter>;
      else if (dim > 16)
  ...
  inline static deglib::search::ResultSet exploreFP16InnerProduct(const ReadOnlyGraph& graph, const uint32_t entry_vertex_index, const uint32_t k, const bool include_entry, const uint32_t max_distance_computation_count = 0) {
  ...
  inline static deglib::search::ResultSet exploreFP16InnerProductExt8(const ReadOnlyGraph& graph, const uint32_t entry_vertex_index, const uint32_t k, const bool include_entry, const uint32_t max_distance_computation_count = 0) {
  ...
  inline static deglib::search::ResultSet exploreFP16InnerProductExt16(const ReadOnlyGraph& graph, const uint32_t entry_vertex_index, const uint32_t k, const bool include_entry, const uint32_t max_distance_computation_count = 0) {
  ...
  inline static deglib::search::ResultSet exploreFP16InnerProductExt32(const ReadOnlyGraph& graph, const uint32_t entry_vertex_index, const uint32_t k, const bool include_entry, const uint32_t max_distance_computation_count = 0) {
  ...
  inline static deglib::search::ResultSet exploreFP16InnerProductExt16Residual(const ReadOnlyGraph& graph, const uint32_t entry_vertex_index, const uint32_t k, const bool include_entry, const uint32_t max_distance_computation_count = 0) {
  ...
  inline static deglib::search::ResultSet exploreFP16InnerProductExt8Residual(const ReadOnlyGraph& graph, const uint32_t entry_vertex_index, const uint32_t k, const bool include_entry, const uint32_t max_distance_computation_count = 0) {
  ...
  inline static EXPLOREFUNC getExploreFunction(const deglib::FloatSpace& feature_space) {
    ...
    {
      if (dim % 32 == 0)
        return deglib::graph::ReadOnlyGraph::exploreFP16InnerProductExt32;
      else if (dim % 16 == 0)
        return deglib::graph::ReadOnlyGraph::exploreFP16InnerProductExt16;
      else if (dim % 8 == 0)
        return deglib::graph::ReadOnlyGraph::exploreFP16InnerProductExt8;
      else if (dim > 16)
