        ...
        auto batch_impl = [query, dim](const void* const* db, float* out_dists) DEGLIB_TARGET_AVX512 {
            ...
            if constexpr (HasDualSimd) {
                ...
                for (size_t c = 0; c < nc64; ++c) {
                    ...
                    __m512i q_vec_lo = _mm512_cvtepu8_epi16(q_raw_lo);
                    __m512i q_vec_hi = _mm512_cvtepu8_epi16(q_raw_hi);
                    ...
                    for (size_t j = 0; j < BATCH_SIZE; ++j) {
                        ...
                        __m512i diff_lo = _mm512_sub_epi16(q_vec_lo, _mm512_cvtepu8_epi16(r_raw_lo));
                        __m512i diff_hi = _mm512_sub_epi16(q_vec_hi, _mm512_cvtepu8_epi16(r_raw_hi));
        ...
        auto batch_impl = [query, dim](const void* const* db, float* out_dists) DEGLIB_TARGET_AVX2 {
            ...
            if constexpr (HasDualSimd) {
                ...
                for (size_t c = 0; c < nc32; ++c) {
                    ...
                    __m256i q_vec_lo = _mm256_cvtepu8_epi16(q_raw_lo);
                    __m256i q_vec_hi = _mm256_cvtepu8_epi16(q_raw_hi);
                    ...
                    for (size_t j = 0; j < BATCH_SIZE; ++j) {
                        ...
                        __m256i diff_lo = _mm256_sub_epi16(q_vec_lo, _mm256_cvtepu8_epi16(r_raw_lo));
                        __m256i diff_hi = _mm256_sub_epi16(q_vec_hi, _mm256_cvtepu8_epi16(r_raw_hi));
