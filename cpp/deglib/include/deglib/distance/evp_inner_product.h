    ...
    inline DistanceVariant select_dist(const size_t dim, const deglib::cpu::InstructionSet instruction = deglib::cpu::InstructionSet::Auto) {
        ...
        if (instruction == deglib::cpu::InstructionSet::AVX512 || (instruction == deglib::cpu::InstructionSet::Auto && deglib::cpu::has_avx512())) {
            ...
            if (dim < 512) {
                ...
                if (dim == 512) return EvpInnerProduct_AVX512<ResidualMode::SimdOnly>{};
                else return EvpInnerProduct_AVX512<ResidualMode::SimdTail>{};
            } else {
                if (dim % 1024 == 0) return EvpInnerProduct_AVX512<ResidualMode::DualOnly>{};
                else if (dim % 512 == 0) return EvpInnerProduct_AVX512<ResidualMode::DualPlusSimd>{};
                else return EvpInnerProduct_AVX512<ResidualMode::Full>{};
            }
        }
            ...
            if (dim < 256) {
                ...
                if (dim == 256) return EvpInnerProduct_AVX2<ResidualMode::SimdOnly>{};
                else return EvpInnerProduct_AVX2<ResidualMode::SimdTail>{};
            } else {
                if (dim % 512 == 0) return EvpInnerProduct_AVX2<ResidualMode::DualOnly>{};
                else if (dim % 256 == 0) return EvpInnerProduct_AVX2<ResidualMode::DualPlusSimd>{};
                else return EvpInnerProduct_AVX2<ResidualMode::Full>{};
            }
        }
#else
