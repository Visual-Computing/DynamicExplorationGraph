...
public class GraphSearch {
	...
	public static TreeSet<ObjectDistance> search(MemoryView query, int k, float eps, int[] forbiddenIds, int[] entryPoints, EvenRegularWeightedUndirectedGraph graph) {
